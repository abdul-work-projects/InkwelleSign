...
/**
 * Base URL used in signing links. APP_URL wins; otherwise fall back to the hostname the
 * platform advertises, so a deployment does not email links pointing at localhost.
 */
